  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={[styles.subtitle, styles.textStroke]}>Cross</Text>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://youtu.be/oGUJHe8DbH0?si=RKoeU1PdoK7ZhJZO')}>
          <Image
            source={require('../assets/Clipcross.jpg')}

  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={[styles.subtitle, styles.textStroke]}>Uppercut</Text>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://youtu.be/L5a9L--Jszw?si=ouNbJ6StGnXHnGp9')}>
          <Image
            source={require('../assets/clipuppercut.jpg')}

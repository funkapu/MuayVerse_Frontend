...
interface JabScreenProps {
  navigation: any;
}

function JabScreen({ navigation }: JabScreenProps) {
  return (
    <ImageBackground
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={[styles.subtitle, styles.textStroke]}>Jab</Text>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://youtu.be/zkoVmAJW02s?si=dCiKcZ3NQFrP894n')}>
          <Image
            source={require('../assets/Clipjab.jpg')}
